...
from loan_api.models import Loan, Payment, Client
...
class TestViews(TestCase):
    def setUp(self) -> None:
        ...
        self.client_url = reverse('loan_api:clients')
        self.loan_url = reverse('loan_api:loans')
        self.payment_url = reverse('loan_api:payments', kwargs={'loan_id': self.loan.loan_id})
